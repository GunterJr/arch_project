...
The Nand circuit is composed of a Not gate and an And gate. Two inputs, A and B, are input into an And gate. The output of the And gate is then inverted and output to X.
